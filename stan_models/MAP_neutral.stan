 ...
 //spline 1
  ...
  real[] solve_chi(real solve_time,            // time point of observation
    ...
    real[] parms){
      ...
      init_tb[3] = y0[1];                               //at tbmt - all ki67Hi cells are host
      init_tb[4] = y0[2];                               //at tbmt - all ki67Lo cells are host
...
generated quantities{
  ...
  //y_ont_pred = solve_ode_ont(ts_pred_ont, init_cond, to_array_1d(global_params));
  ...
  for (i in 1:numPred){
    y3_mean_pred1[i] = y_chi_pred1[i, 1] + y_chi_pred1[i, 2] + y_chi_pred1[i, 3] + y_chi_pred1[i, 4];
    y3_mean_pred2[i] = y_chi_pred2[i, 1] + y_chi_pred2[i, 2] + y_chi_pred2[i, 3] + y_chi_pred2[i, 4];
    y3_mean_pred3[i] = y_chi_pred3[i, 1] + y_chi_pred3[i, 2] + y_chi_pred3[i, 3] + y_chi_pred3[i, 4];

    y4_mean_pred1[i] = (y_chi_pred1[i, 1] + y_chi_pred1[i, 2])/(y3_mean_pred1[i] * Chi_spline(ts_pred_chi1[i] - 54));
    y4_mean_pred2[i] = (y_chi_pred2[i, 1] + y_chi_pred2[i, 2])/(y3_mean_pred2[i] * Chi_spline(ts_pred_chi2[i] - 71));
    y4_mean_pred3[i] = (y_chi_pred3[i, 1] + y_chi_pred3[i, 2])/(y3_mean_pred3[i] * Chi_spline(ts_pred_chi3[i] - 97));

    y6_mean_pred1[i] = y_chi_pred1[i, 1]/(y_chi_pred1[i, 1] + y_chi_pred1[i, 2]);
    y6_mean_pred2[i] = y_chi_pred2[i, 1]/(y_chi_pred2[i, 1] + y_chi_pred2[i, 2]);
    y6_mean_pred3[i] = y_chi_pred3[i, 1]/(y_chi_pred3[i, 1] + y_chi_pred3[i, 2]);

    y5_mean_pred1[i] = y_chi_pred1[i, 3]/(y_chi_pred1[i, 3] + y_chi_pred1[i, 4]);
    y5_mean_pred2[i] = y_chi_pred2[i, 3]/(y_chi_pred2[i, 3] + y_chi_pred2[i, 4]);
    y5_mean_pred3[i] = y_chi_pred3[i, 3]/(y_chi_pred3[i, 3] + y_chi_pred3[i, 4]);
