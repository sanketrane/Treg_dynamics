...
model{
  ...
  sigma_counts_per ~ normal(0.5, 0.01);
  sigma_counts_thy ~ normal(0.7, 0.01);
  sigma_Nfd_per ~ normal(0.4, 0.01);
  sigma_Nfd_thy ~ normal(0.7, 0.01);
  sigma_donor_ki_per ~ normal(0.3, 0.01);
  sigma_donor_ki_thy ~ normal(0.3, 0.01);
  sigma_host_ki_per ~ normal(0.2, 0.01);
  sigma_host_ki_thy ~ normal(0.3, 0.01);
