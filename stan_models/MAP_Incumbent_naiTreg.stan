...
generated quantities{
  ...
  for (i in 1:numPred){
    ...
    Nfd_per_mean_pred2[i] = (y_chi_pred2[i, 11] + y_chi_pred2[i, 12])/(counts_per_mean_pred1[i] * Chi_spline(ts_pred2[i] - tb_pred2[i]));
    Nfd_per_mean_pred3[i] = (y_chi_pred3[i, 11] + y_chi_pred3[i, 12])/(counts_per_mean_pred1[i] * Chi_spline(ts_pred3[i] - tb_pred3[i]));
    Nfd_per_mean_pred4[i] = (y_chi_pred4[i, 11] + y_chi_pred4[i, 12])/(counts_per_mean_pred1[i] * Chi_spline(ts_pred4[i] - tb_pred4[i]));
