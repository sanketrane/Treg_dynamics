...
modelName <- "NeutraModel_SP4source"
...
## run Stan
#### compile model
model_file <- file.path(modelDir, 'NeutraModel_SP4Source.stan')
...
write.csv(out_table, file = file.path(outputDir, modelName, paste0('params_', modelName, ".csv")))
...
write.csv(ploocv, file = file.path(outputDir, modelName, paste0('stats_', modelName, ".csv")))
