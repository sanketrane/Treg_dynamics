...
stanmodel_file <- file.path("stan_models", "MAP_Incumbent_naiTreg.stan")
...
init_cond <- c(exp(8.5), exp(10), exp(8.75), exp(12.4), exp(10.5), exp(12), exp(9.9), exp(11.14),
               0,0,0,0)
params <- c(0.002, 0.0003, 0.15, 0.003, 0.03, 0.004, 0.03)

global_parms <- c(params,init_cond)
ode_sol <- solve_ode_chi(ts_seq, agebmtseq, init_cond, params)
math_reduce(global_parms, local_params = c(0), x_r = 100, x_i = 45)
